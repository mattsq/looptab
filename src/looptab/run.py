...
def _build_model(
    ...
    # Both the TRM loop and the untied-stack control (§4b) emit per-step readouts, so
    # deep supervision can be ablated on the same axis for each.
    if arm.name in ("trm", "untied_stack"):
